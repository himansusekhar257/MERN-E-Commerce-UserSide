...
import {FiEdit, LuEdit} from "react-icons/fi"
...
const userState = useSelector(state=> state.auth.user)
    ...
    return (
        <>
            ...
            <Container class1='cart-wrappper home-wrapper-2 py-5'>
                <div className='row'>
                    ...
                    <div className='col-12'>
                        <form onSubmit={formik.handleSubmit}>
                            <div className="mb-3">
                                <label htmlFor="example1" clclassNameass="form-label">First Name</label>
                            ...
                            <div className="mb-3">
                                <label htmlFor="example2" clclassNameass="form-label">Last Name</label>
